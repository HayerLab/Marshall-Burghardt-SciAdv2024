...
if nargin<3
    ...
    bg_level=nanmedian(vect(im_in(~mask))); % median intensity of background within image
    bg_bg=nanmedian(vect(bg_image(~mask))); % median intensity within mask in background image
